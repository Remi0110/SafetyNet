...
public class FirestationServiceTest {
    ...
    @Test
	 public void testGetAddressStationsFromStationNumber () throws Exception {
		...
		List<String> listAddress = firestationService.getAddressStationsFromStationNumber(stationNumber);
    ...
    @Test
	 public void testGetPersonsFromAddressStation () throws Exception {
		...
		listAdress.add("947 E. Rose Dr");
 		...
 		List<Person> listPersonResult = firestationService.getPersonsFromAddressStation(listAdress);
